                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    //     // Kiểm tra xem có bất kỳ hàng nào trả về từ cơ sở dữ liệu không
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        ...
                                        // Xây dựng truy vấn SQL để lấy mật khẩu đã băm từ cơ sở dữ liệu
                                        $sql = "SELECT matkhau, idvaitro FROM khachhang WHERE email = '$email'";
                                        $result = $conn->query($sql);
